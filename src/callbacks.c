                                        ...
                                        gpointer         user_data)
{
   ...
   if( temp_file_aptgetcall_sh_fd == NULL )
       ...
       fprintf( temp_file_aptgetcall_sh_fd, "%s\n%s\n%s\n%s%s\n%s\n%s%s%s\n%s%s%s\n%s\n%s%s%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s%s%s%s%s\n%s\n%s\n%s\n%s%s%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s%s%s%s%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s%s%s\n%s\n%s\n",
               ...
               "while [ \"${i}\" != \"\" ]; do",
               "      printf \"\\n==================================\\n\"",
               "      printf \"enter your code or close the window <ALT> + <F4>\\n\"",
               "      printf \"# \";read i",
                                        ...
                                        gpointer         user_data)
{
   ...
   if ( strlen(CHROOT) > 0 && strcmp( ptr_chroot, "--chroot" ) == 0 ) {
      ...
      strncat(system_call, "-e 's|\\(.*deb.*sidux.* main\\).*|\\1 contrib non-free fix.main fix.contrib fix.non-free|' /media/", MAXLINE );
      strncat(system_call, hd_device, MAXLINE );
