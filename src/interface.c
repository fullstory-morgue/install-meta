...
create_dialog1 (void)
{
  ...
  dialog1_icon_pixbuf = create_pixbuf ("sidux-meta.png");
...
create_dialog2 (void)
{
  ...
  dialog2_icon_pixbuf = create_pixbuf ("sidux-meta.png");
...
create_package_info (void)
{
  ...
  package_info_icon_pixbuf = create_pixbuf ("sidux-meta.png");
...
create_window_main (void)
{
  ...
  label17 = gtk_label_new (_("<b><span color=\"darkgreen\">non-free sources</span></b>"));
